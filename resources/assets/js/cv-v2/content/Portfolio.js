                            ...
                            <div className="nav-align-center">
                                <ul className="nav nav-pills nav-pills-primary" role="tablist">
                                    <li className="nav-item"><a className="nav-link active"
                                                                data-toggle="tab" href="#web-development"
                                                                role="tablist"><i className="fa fa-laptop"
                                                                                  aria-hidden="true"></i></a>
                                    </li>
                                    {/*<li className="nav-item"><a className="nav-link" data-toggle="tab"*/}
                                                                {/*href="#graphic-design" role="tablist"><i*/}
                                        {/*className="fa fa-picture-o" aria-hidden="true"></i></a></li>*/}
                                    {/*<li className="nav-item"><a className="nav-link" data-toggle="tab"*/}
                                                                {/*href="#Photography" role="tablist"><i*/}
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="cc-porfolio-image img-raised" data-aos="fade-up"
                                            ...
                                            <figure className="cc-effect"><img src="cv-v2/images/1.png" alt="Image"/>
                                                <figcaption>
                                        ...
                                        <div className="cc-porfolio-image img-raised" data-aos="fade-up"
                                             data-aos-anchor-placement="top-bottom"><a
                                            href="#web-development">
                                            <figure className="cc-effect"><img src="cv-v2/images/2.png"
                                                                               alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div className="col-md-6">
                                        <div className="cc-porfolio-image img-raised" data-aos="fade-up"
                                             data-aos-anchor-placement="top-bottom"><a
                                            href="#web-development">
                                            <figure className="cc-effect"><img src="cv-v2/images/3.png"
                                                                               alt="Image"/>
                                                <figcaption>
                                        ...
                                        <div className="cc-porfolio-image img-raised" data-aos="fade-up"
                                             data-aos-anchor-placement="top-bottom"><a
                                            href="#web-development">
                                            <figure className="cc-effect"><img src="cv-v2/images/4.png"
                                                                               alt="Image"/>
                                                <figcaption>
                                ...
                                {/*<div className="row">*/}
                                    {/*<div className="col-md-6">*/}
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                             {/*data-aos-anchor-placement="top-bottom"><a*/}
                                            {/*href="#graphic-design">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/graphic-design-1.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                        ...
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                            ...
                                            {/*href="#graphic-design">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/graphic-design-2.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                    ...
                                    {/*<div className="col-md-6">*/}
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                            ...
                                            {/*href="#graphic-design">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/graphic-design-3.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                        ...
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                            ...
                                            {/*href="#graphic-design">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/graphic-design-4.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                ...
                                {/*<div className="row">*/}
                                    {/*<div className="col-md-6">*/}
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                            ...
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/photography-1.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                        ...
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                             {/*data-aos-anchor-placement="top-bottom"><a href="#Photography">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/photography-3.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                    ...
                                    {/*<div className="col-md-6">*/}
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                             {/*data-aos-anchor-placement="top-bottom"><a href="#Photography">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/photography-2.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
                                        ...
                                        {/*<div className="cc-porfolio-image img-raised" data-aos="fade-up"*/}
                                             {/*data-aos-anchor-placement="top-bottom"><a href="#Photography">*/}
                                            {/*<figure className="cc-effect"><img*/}
                                                {/*src="cv-v2/images/photography-4.jpg" alt="Image"/>*/}
                                                {/*<figcaption>*/}
